...
use crate::Month;
use crate::ParseMonthError;
use crate::ParseWeekdayError;
use crate::Weekday;
...
#[cfg(feature = "alloc")]
#[allow(deprecated)]
pub use formatting::format_item;
...
enum InternalInternal {
  ...
  /// Same as [`Nanosecond`](#variant.Nanosecond) but the accuracy is fixed to 3 and there is no
  /// leading dot.
  Nanosecond3NoDot,
  /// Same as [`Nanosecond`](#variant.Nanosecond) but the accuracy is fixed to 6 and there is no
  /// leading dot.
  Nanosecond6NoDot,
  /// Same as [`Nanosecond`](#variant.Nanosecond) but the accuracy is fixed to 9 and there is no
  /// leading dot.
  Nanosecond9NoDot,
}
