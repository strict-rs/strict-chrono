...
use crate::TimeDelta;
use crate::Weekday;
use crate::naive::internals::A;
use crate::naive::internals::AG;
use crate::naive::internals::B;
use crate::naive::internals::BA;
use crate::naive::internals::C;
use crate::naive::internals::CB;
use crate::naive::internals::D;
use crate::naive::internals::DC;
use crate::naive::internals::E;
use crate::naive::internals::ED;
use crate::naive::internals::F;
use crate::naive::internals::FE;
use crate::naive::internals::G;
use crate::naive::internals::GF;
...
fn test_date_from_str() {
  // valid cases
  let valid = [
    "-0000000123456-1-2", "    -123456 - 1 - 2    ", "-12345-1-2", "-1234-12-31", "-7-6-5", "350-2-28", "360-02-29", "0360-02-29",
    "2015-2 -18", "2015-02-18", "+70-2-18", "+70000-2-18", "+00007-2-18",
  ];
  for &s in &valid {
...
fn test_rkyv_validation() {
  ...
  assert_eq!(crate::rkyv_test::roundtrip(&date_min).unwrap(), date_min);

  let date_max = NaiveDate::MAX;
  assert_eq!(crate::rkyv_test::roundtrip(&date_max).unwrap(), date_max);
}
