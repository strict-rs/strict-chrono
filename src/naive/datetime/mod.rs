...
impl NaiveDateTime {
  ...
  ///   Ok(
  ///     NaiveDate::from_ymd_opt(2015, 9, 5)
  ///       .unwrap()
  ...
  /// ```rust
  /// # use chrono::{NaiveDate, NaiveDateTime};
  /// let (datetime, remainder) =
  ///   NaiveDateTime::parse_and_remainder("2015-02-18 23:16:09 trailing text", "%Y-%m-%d %H:%M:%S")
  ///     .unwrap();
  /// assert_eq!(
  ///   datetime,
  ...
  /// assert_eq!(
  ///   hms(3, 5, 7).checked_add_signed(TimeDelta::zero()),
  ///   Some(hms(3, 5, 7))
  /// );
  /// assert_eq!(
  ...
  ///   d.and_hms_opt(3, 5, 7)
  ///     .unwrap()
  ///     .signed_duration_since(d.and_hms_opt(2, 4, 6).unwrap()),
  ...
  /// assert_eq!(
  ///   dt.format_with_items(fmt.clone()).to_string(),
  ///   "2015-09-05 23:56:04"
  /// );
  /// assert_eq!(
  ...
  /// );
  /// assert_eq!(
  ///   dt.format("around %l %p on %b %-d").to_string(),
  ///   "around 11 PM on Sep 5"
  /// );
  /// ```
  ///
  /// The resulting `DelayedFormat` can be formatted directly via the `Display` trait.
  ...
  /// );
  /// assert_eq!(
  ///   format!("{}", dt.format("around %l %p on %b %-d")),
  ///   "around 11 PM on Sep 5"
  /// );
  /// ```
  #[cfg(feature = "alloc")]
  ...
  /// use chrono::NaiveDate;
  /// use chrono::Utc;
  /// let dt = NaiveDate::from_ymd_opt(2023, 1, 30)
  ///   .unwrap()
...
impl Datelike for NaiveDateTime {
  ...
  fn with_year(&self, year: i32) -> Option<NaiveDateTime> {
    self.date.with_year(year).map(|d| NaiveDateTime {
      date: d,
      ..*self
    })
  }
  ...
  fn with_month(&self, month: u32) -> Option<NaiveDateTime> {
    self.date.with_month(month).map(|d| NaiveDateTime {
      date: d,
      ..*self
    })
  }
  ...
  fn with_month0(&self, month0: u32) -> Option<NaiveDateTime> {
    self.date.with_month0(month0).map(|d| NaiveDateTime {
      date: d,
      ..*self
    })
  }
  ...
  fn with_day(&self, day: u32) -> Option<NaiveDateTime> {
    self.date.with_day(day).map(|d| NaiveDateTime {
      date: d,
      ..*self
    })
  }
  ...
  fn with_day0(&self, day0: u32) -> Option<NaiveDateTime> {
    self.date.with_day0(day0).map(|d| NaiveDateTime {
      date: d,
      ..*self
    })
  }
  ...
  fn with_ordinal(&self, ordinal: u32) -> Option<NaiveDateTime> {
    self.date.with_ordinal(ordinal).map(|d| NaiveDateTime {
      date: d,
      ..*self
    })
  }
  ...
  fn with_ordinal0(&self, ordinal0: u32) -> Option<NaiveDateTime> {
    self.date.with_ordinal0(ordinal0).map(|d| NaiveDateTime {
      date: d,
      ..*self
    })
  }
...
impl Timelike for NaiveDateTime {
  ...
  fn with_hour(&self, hour: u32) -> Option<NaiveDateTime> {
    self.time.with_hour(hour).map(|t| NaiveDateTime {
      time: t,
      ..*self
    })
  }
  ...
  fn with_minute(&self, min: u32) -> Option<NaiveDateTime> {
    self.time.with_minute(min).map(|t| NaiveDateTime {
      time: t,
      ..*self
    })
  }
  ...
  fn with_second(&self, sec: u32) -> Option<NaiveDateTime> {
    self.time.with_second(sec).map(|t| NaiveDateTime {
      time: t,
      ..*self
    })
  }
  ...
  /// let dt: NaiveDateTime = NaiveDate::from_ymd_opt(2015, 9, 8)
  ///   .unwrap()
  ///   .and_hms_milli_opt(12, 34, 59, 789)
  ///   .unwrap();
  /// assert_eq!(
  ...
  fn with_nanosecond(&self, nano: u32) -> Option<NaiveDateTime> {
    self.time.with_nanosecond(nano).map(|t| NaiveDateTime {
      time: t,
      ..*self
    })
  }
...
/// assert_eq!(
///   hms(3, 5, 7) + TimeDelta::try_seconds(1).unwrap(),
///   hms(3, 5, 8)
/// );
/// assert_eq!(
///   hms(3, 5, 7) + TimeDelta::try_seconds(-1).unwrap(),
...
/// );
/// assert_eq!(
///   hms(3, 5, 7) + TimeDelta::try_seconds(3600 + 60).unwrap(),
///   hms(4, 6, 7)
/// );
/// assert_eq!(
...
/// let hmsm = |h, m, s, milli| d.and_hms_milli_opt(h, m, s, milli).unwrap();
/// assert_eq!(
///   hmsm(3, 5, 7, 980) + TimeDelta::try_milliseconds(450).unwrap(),
///   hmsm(3, 5, 8, 430)
/// );
/// ```
///
...
/// let hmsm = |h, m, s, milli| d.and_hms_milli_opt(h, m, s, milli).unwrap();
/// assert_eq!(
///   hmsm(3, 5, 7, 450) - TimeDelta::try_milliseconds(670).unwrap(),
///   hmsm(3, 5, 6, 780)
/// );
/// ```
///
...
///
/// let dt = NaiveDate::from_ymd_opt(12345, 6, 7)
///   .unwrap()
///   .and_hms_milli_opt(7, 59, 59, 1_500)
///   .unwrap(); // leap second
